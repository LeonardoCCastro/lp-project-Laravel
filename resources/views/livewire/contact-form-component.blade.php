            ...
            <div class="py-8 lg:py-16 px-4 mx-auto">
                ...
                <form wire:submit.prevent="submit" class="space-y-8">
                    <div class="flex flex-col">
                        ...
                        <input type="email" id="email" wire:model="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="example@mail.com">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input onkeyup="this.value = tel_format(this.value)" type="text" id="phone" wire:model="phone" maxlength="15" class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500" placeholder="(16) 9 9999-9999">
                    ...
                    <div class="sm:col-span-2 flex flex-col">
                        ...
                        <textarea id="content" wire:model="content" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Escreva aqui sua mensagem"></textarea>
