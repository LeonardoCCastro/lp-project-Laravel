<x-action-section>
    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Você tem certeza de que deseja excluir sua conta? Uma vez que sua conta for excluída, todos os seus recursos e dados serão permanentemente apagados. Por favor, insira sua senha para confirmar que você deseja excluir sua conta permanentemente.') }}
